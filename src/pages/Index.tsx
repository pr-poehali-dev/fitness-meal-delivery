...
const faq = [
  { q: 'Еда действительно будет вкусной после разморозки?', a: 'Да! Наш промышленный шкаф шоковой заморозки замораживает еду за минуты. Вода превращается в микрокристаллы, не повреждая клетки. После 5 минут в микроволновке блюдо по вкусу, сочности и аромату на 100% идентично свежему. И сохраняет 95% витаминов.' },
  ...
  { q: 'Насколько точен ваш КБЖУ? Можно ли доверять этикетке?', a: 'Это наше главное отличие от масс-маркета. Меню разрабатывает и контролирует специализированный спортивный технолог по строгим ГОСТам. Мы не используем лишний жирный соус, сахар, масло ради усиления вкуса.' },
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center mb-14">
          <div>
            ...
            <p className="text-muted-foreground">
              Разработано спортивным технологом и рекомендовано лучшими фитнес-тренерами. Скидка до 15% за количество дней.
            </p>
          </div>
...
Расчёт готов — доведём его до идеала вместе
            ...
            <p className="text-muted-foreground mb-8">
              Оставьте заявку — бесплатно поможем рассчитать КБЖУ под вашу цель с технологом и забронируем рацион со скидкой.
            </p>
            {sent ? (
